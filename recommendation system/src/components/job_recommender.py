...
# Load dataset:
jd_df=pd.read_csv(r'E:\Job-Recommendation-System\src\data\jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'E:\Job-Recommendation-System\utilities\resumes\CV.pdf'
skills=[]
...
jd_df_sorted = jd_df.sort_values('match', ascending=False)  # Sort the DataFrame by match confidence in descending order
top_5_max_matches = jd_df_sorted.head(5) 
