...
const Timer = () => {
    ...
    return (
        <div>
            {showTimer ? (
                <div className="flex items-center space-x-2 bg-gray-900 p-1.5 cursor-pointer rounded hover:bg-gray-600">
                ...
                <div className="flex items-center p-1 h-8 bg-gray-900 hover:bg-gray-600 rounded cursor-pointer" onClick={() => setShowTimer(true)}>
                    <svg
